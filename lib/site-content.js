...
export const BLOCK_DEFAULTS = {
  ...
  craft: {
    image: ASSETS.craft,
    imageMobile: '',
    // Foto o video de la cápsula (el óvalo alto del diseño).
    media: { type: 'image', image: ASSETS.craft, imageMobile: '', src: '', poster: '' },
  ...
  categorias: {
    ...
    // Vacío = la primera categoría del catálogo (normalmente "Bolsas").
    categoria: '',
    cta: { text: 'Ver todo', to: 'catalogo' },
  },
  armaTuTaluna: {
    eyebrow: 'Personalízalo',
    title: 'Arma tu *Taluna.*',
    lead: 'Elige tu bolsa, combínala con un strap y crea tu pieza. El total se actualiza al instante.',
  },
  destacados: {
...
export const SITE_DEFAULTS = {
  ...
  // El aviso que sale una sola vez por visita, unos segundos después de entrar.
  popup: {
    on: true,
    image: '',
    text: 'Mantente al tanto de nuestros lanzamientos, novedades y piezas especiales.',
    title: 'Únete hoy y recibe acceso antes que nadie a nuevas colecciones.',
  },
};
...
export function mergeSiteContent(doc) {
  ...
  return {
    ...
    popup: { ...SITE_DEFAULTS.popup, ...(isObj(saved.popup) ? saved.popup : {}) },
