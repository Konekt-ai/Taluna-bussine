...
// Botón redondo flotante, alineado al borde de la columna del diseño.
export default function WhatsAppButton({
  ...
  return (
    <a className="tl-wa" href={href} target="_blank" rel="noopener noreferrer" aria-label="Pedir por WhatsApp">
      <i aria-hidden="true" />
