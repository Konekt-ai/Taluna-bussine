...
import { TalunaStoreProvider } from "../lib/taluna/store";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Taluna · Bolsas artesanales mexicanas" },
      {
        name: "description",
        content:
          "Bolsas de piel hechas a mano en México con straps intercambiables. Arma tu Taluna: elige bolsa, color y strap.",
      },
      { name: "author", content: "Taluna" },
